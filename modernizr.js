window.Modernizr = function(e, d, y) {
    ...
    var c = {}, v = d.documentElement, i = d.createElement("modernizr"), w = i.style, z = ["", "-webkit-", "-moz-", "-o-", "-ms-"], x = ["Webkit", "Moz", "O", "ms"], m = ["webkit", "moz", "o", "ms"], i = {}, h = [], q = h.slice, o, u = function(a, b, k, f) {
        var r, g, j, c = d.createElement("div"), l = d.body, A = l ? l : d.createElement("body");
        if (parseInt(k, 10))
            for (; k--; )
                j = d.createElement("div"),
                j.id = f ? f[k] : "modernizr" + (k + 1),
                c.appendChild(j);
        return r = ["&#173;<style>", a, "</style>"].join(""),
        c.id = "modernizr",
        A.innerHTML += r,
        A.appendChild(c),
        ...
        v.appendChild(A)),
        g = b(c, a),
        l ? c.parentNode.removeChild(c) : A.parentNode.removeChild(A),
        !!g
    }, a = {}.hasOwnProperty, r;
        ...
        var k = q.call(arguments, 1)
          , f = function() {
            if (this instanceof f) {
                ...
                var d = new d
                  , g = b.apply(d, k.concat(q.call(arguments)));
                return Object(g) === g ? g : d
            }
            return b.apply(a, k.concat(q.call(arguments)))
        };
        return f
    }
    );
    (function(a, b) {
        var k = a.join("")
          , f = b.length;
        u(k, function(a, k) {
            for (var b = d.styleSheets[d.styleSheets.length - 1], b = b ? b.cssRules && b.cssRules[0] ? b.cssRules[0].cssText : b.cssText || "" : "", r = a.childNodes, l = {}; f--; )
                l[r[f].id] = r[f];
            ...
            c.fontface = /src/i.test(b) && 0 === b.indexOf(k.split(" ")[0])
        }, f, b)
    }
    ...
    i.csstransforms3d = function() {
        var a = !!t("perspective");
        return a && "webkitPerspective"in v.style && (a = c.csstransforms3d),
        a
    }
    ;
    ...
    c.mq = function(a) {
        ...
        return u("@media " + a + " { #modernizr { position: absolute; } }", function(a) {
            k = "absolute" == (e.getComputedStyle ? getComputedStyle(a, null) : a.currentStyle).position
        }),
        k
    }
    ,
    ...
    c.testAllProps = t,
    c.testStyles = u,
    v.className = v.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (" js " + h.join(" ")),
    c
}(this, this.document);
(function(e, d) {
    function y(a, d) {
        ...
        return c.innerHTML = "x<style>" + d + "</style>",
        i.insertBefore(c.lastChild, i.firstChild)
    }
    function s() {
        var a = h.elements;
    ...
    function t(a) {
        ...
        ;
        a.createDocumentFragment = Function("h,f", "return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&(" + s().join().replace(/\w+/g, function(a) {
            return d[a] = c(a),
            b.createElement(a),
            'c("' + a + '")'
        }) + ");return n}")(h, b)
    ...
    function c(a) {
        ...
        m || (d = !t(a)),
        d && (a.documentShived = d),
        a)
    }
    function v(a) {
        for (var d, c = a.attributes, i = c.length, b = a.ownerDocument.createElement(o + ":" + a.nodeName); i--; )
            d = c[i],
            d.specified && b.setAttribute(d.nodeName, d.nodeValue);
        return b.style.cssText = a.style.cssText,
        b
    }
    function i(a) {
        var d, c, i = a.namespaces, b = a.parentWindow;
        return !u || a.printShived ? a : ("undefined" == typeof i[o] && i.add(o),
        b.attachEvent("onbeforeprint", function() {
            var b, f, i;
            b = a.styleSheets;
            for (var g = [], j = b.length, h = Array(j); j--; )
                h[j] = b[j];
            for (; i = h.pop(); )
                if (!i.disabled && q.test(i.media)) {
                    b = i.imports;
                    j = 0;
            ...
            for (f = "$1" + o + "\\:$2"; h--; )
                g = j[h] = j[h].split("}"),
                g[g.length - 1] = g[g.length - 1].replace(b, f),
                j[h] = g.join("}");
            g = j.join("{");
            ...
            for (i = []; b--; )
                j = h[b],
                f.test(j.nodeName) && i.push(j.applyElement(v(j)));
            c = i;
            d = y(a, g)
        }),
        b.attachEvent("onafterprint", function() {
            for (var a = c, b = a.length; b--; )
                a[b].removeNode();
            d.removeNode(!0)
        }),
        a.printShived = !0,
    ...
    var q = /^$|\b(?:all|print)\b/
      ...
      , u = !m && function() {
        ...
        return "undefined" != typeof d.namespaces && "undefined" != typeof d.parentWindow && "undefined" != typeof a.applyElement && "undefined" != typeof a.removeNode && "undefined" != typeof e.attachEvent
    }();
    h.type += " print";
    h.shivPrint = i;
    i(d)
...
(function(e, d, y) {
    ...
    function w(b, c, f, j, k, e, p) {
        function F(d) {
            ...
            d)) {
                ...
                for (var f in g[c])
                    g[c].hasOwnProperty(f) && g[c][f].onload()
            }
        }
        ...
        ;
        u.splice(j, 0, o);
        "img" != b && (m || 2 === g[c] ? (D.insertBefore(n, B ? null : q),
        h(F, p)) : g[c].push(n))
    }
    function z(d, c, f, g, h) {
        return a = 0,
        c = c || "j",
        t(d) ? w("c" == c ? k : b, d, c, this.i++, f, g, h) : (u.splice(this.i++, 0, d),
        1 == u.length && i()),
        this
    }
    function x() {
    ...
    l = function(a) {
        function b(a) {
            var a = a.split("!"), d = C.length, c = a.pop(), i = a.length, c = {
                url: c,
                origUrl: c,
                prefixes: a
            }, f, h, g;
        ...
        function d(a, c, f, h, k) {
            ...
            e.bypass || (c && (c = s(c) ? c : c[a] || c[h] || c[a.split("/").pop().split("?")[0]] || i),
            e.instead ? e.instead(a, c, f, h, k) : (g[e.url] ? e.noexec = !0 : g[e.url] = 1,
            f.load(e.url, e.forceCSS || !e.forceJS && "css" == e.url.split(".").pop().split("?").shift() ? "c" : y, e.noexec, e.attrs, e.timeout),
                ...
                if (a)
                    if (t(a))
                        ...
                        if (Object(a) === a)
                            ...
                            a)
                                a.hasOwnProperty(p) && (!c && !--l && (s(g) ? g = function() {
                                    var a = [].slice.call(arguments);
                                    k.apply(this, a);
                                    j()
                                }
        ...
        if (t(a))
            ...
            for (k = 0; k < a.length; k++)
                e = a[k],
                t(e) ? d(e, 0, p, 0) : f(e) ? l(e) : Object(e) === e && h(e, p);
        else
            Object(a) === a && h(a, p)
    }
    ;
    ...
    ;
    l.errorTimeout = 1E4;
    null == d.readyState && d.addEventListener && (d.readyState = "loading",
    d.addEventListener("DOMContentLoaded", E = function() {
    ...
    e.yepnope.injectJs = function(a, b, e, f, g, k) {
        ...
        j.src = a;
        for (n in e)
            j.setAttribute(n, e[n]);
        b = k ? i : b || c;
        j.onreadystatechange = j.onload = function() {
            !m && v(j.readyState) && (m = 1,
            b(),
    ...
    e.yepnope.injectCss = function(a, b, f, e, g, j) {
        var e = d.createElement("link"), k, b = j ? i : b || c;
        e.href = a;
        e.rel = "stylesheet";
        e.type = "text/css";
        for (k in f)
            e.setAttribute(k, f[k]);
        g || (q.parentNode.insertBefore(e, q),
        h(b, 0))
    }
}
)(this, document);
